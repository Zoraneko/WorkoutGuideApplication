                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(checked){
                                    ...
                                    LinearLayout exerciseLayout = new LinearLayout(LegworkoutActivity.this);
                                    ...
                                    Button exerciseButton = new Button(LegworkoutActivity.this);
                                    ...
                                    exerciseButton.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            Intent intent = new Intent(LegworkoutActivity.this, InstructionActivity.class);
