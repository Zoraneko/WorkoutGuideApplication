...
public class ArmworkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout layout = findViewById(R.id.ALayout);
        db.collection("Exercises")
                .whereEqualTo("Muscle","Arm")
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                LinearLayout exerciseLayout = new LinearLayout(ArmworkoutActivity.this);
                                ...
                                Button exerciseButton = new Button(ArmworkoutActivity.this);
                                ...
                                exerciseButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        Intent intent = new Intent(ArmworkoutActivity.this, InstructionActivity.class);
