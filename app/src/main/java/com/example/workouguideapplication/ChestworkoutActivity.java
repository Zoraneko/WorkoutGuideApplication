...
public class ChestworkoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout layout = findViewById(R.id.CLayout);
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(checked){
                                    ...
                                    LinearLayout exerciseLayout = new LinearLayout(ChestworkoutActivity.this);
                                    ...
                                    Button exerciseButton = new Button(ChestworkoutActivity.this);
                                    ...
                                    exerciseButton.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            Intent intent = new Intent(ChestworkoutActivity.this, InstructionActivity.class);
